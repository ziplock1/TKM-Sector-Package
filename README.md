# TKM-Sector-Package
Data source for Turkmenistan(UTAA/UTAK/UTAT/UTAV) Sector Package on Global Nav Generator(GNG)

Full package is available on [files.aero-nav.com](https:/files.aero-nav.com/TKM)
